...
public class LogicAgent {
    ...
    public String accept(String username, String target, String warn){
        User user = Load.loadUser(username);
        User targetUser = Load.loadUser(target);
    ...
    public String rejectSilently(String username, String target, String warn){
        User user = Load.loadUser(username);
        User targetUser = Load.loadUser(target);
        user.getRequests().remove(targetUser.getUsername());
    ...
    public String reject_notify(String username, String target, String warn){
        User user = Load.loadUser(username);
        User targetUser = Load.loadUser(target);
        user.getRequests().remove(targetUser.getUsername());
